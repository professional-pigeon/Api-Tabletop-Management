class CharactersController < ApplicationController
  ...
  def create_params(params)
    @create_params ||= params.permit(:name, :character_type, :character_race, :description, :notes, :char_place_id, :char_place_type)
  end

  def update_params(params)
    @update_params ||= params.permit(:name, :character_type, :character_race, :notes, :description, :char_place_id, :char_place_type)
  end
